package com.molmc.rnimlink.esptouch.wifi;
...
import com.molmc.rnimlink.esptouch.task.__IEsptouchTask;
...
public class EsptouchDemoActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mWifiAdmin = new EspWifiAdmin(this);
